...
enum class CastType { DYNAMIC_CAST, STATIC_CAST };

template <typename To, typename From>
struct DBConnection3Caster {
  static To& Cast(From& object) { return dynamic_cast<To&>(object); }

  static CastType GetCastType() { return CastType::DYNAMIC_CAST; }
};
...
class DBConnection3Caster<MySqlDBConnection3, IDBConnection3> {
 public:
  ...
  static CastType GetCastType() { return CastType::STATIC_CAST; }
};